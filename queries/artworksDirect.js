...
const getAllArtworksDirect = async () => {
    try {
        ...
        return { err: `${err}, sql query error - get all artworks Direct` }
    }
}
...
const getOneArtworkDirect = async (id) => {
    try {
        ...
        return { err: `${err}, sql query error - get one artwork Direct` }
    }
}
...
const deleteArtworkDirect = async (id) => {
    try {
        ...
        return { err: `${err}, sql query error - delete one artwork Direct` }
    }
}
...
const updateArtworkDirect = async (id, artwork) => {
    try {
        ...
        return { err: `${err}, sql query error - updated an artwork - direct` }
    }
}
